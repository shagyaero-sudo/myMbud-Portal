...
export const SoftForceModal: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const checkIsMobile = () => {
      // Deteksi Android Phone & Tablet (Termasuk Samsung DeX / Desktop Mode)
      ...
      // Deteksi iPhone, iPod, dan iPad (iPadOS mengirim MacIntel dengan maxTouchPoints > 1)
  ...
  // Jika bukan perangkat mobile/tablet atau sudah dibuka via PWA standalone
            ...
            <div className="bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800/60 rounded-2xl p-5 text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-[13px] text-red-700/90 dark:text-red-400 mt-2 leading-relaxed">
                  Portal ini terdeteksi sudah terpasang di perangkatmu. <strong className="font-bold underline">Tutup browser ini</strong> dan buka <strong className="font-bold">myMbud</strong> langsung melalui ikon di <strong className="font-bold">Home Screen</strong>.
                </p>
              </div>

              <button
                onClick={handleResetInstall}
                className="text-[11px] text-slate-500 dark:text-zinc-400 hover:text-slate-800 dark:hover:text-zinc-200 underline pt-2 block mx-auto font-medium cursor-pointer"
              >
            ...
            <div className="bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-2xl p-4 text-left space-y-3">
              ...
              <div className="space-y-2.5 text-xs text-slate-700 dark:text-zinc-300">
                <div className="flex items-center gap-3 bg-white dark:bg-zinc-900 p-2.5 rounded-xl border border-slate-200/60 dark:border-zinc-800">
                  ...
                  <span>Tap tombol <strong className="text-blue-500">Share (Bagikan)</strong> <span className="inline-block px-1.5 py-0.5 bg-slate-200 dark:bg-zinc-800 rounded text-[10px]">⎋ / ⇧</span> di menu Safari.</span>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white dark:bg-zinc-900 p-2.5 rounded-xl border border-slate-200/60 dark:border-zinc-800">
                  ...
                  <span>Pilih opsi <strong className="text-slate-900 dark:text-white">"Add to Home Screen"</strong> <span className="inline-block px-1.5 py-0.5 bg-slate-200 dark:bg-zinc-800 rounded text-[10px]">➕</span>.</span>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white dark:bg-zinc-900 p-2.5 rounded-xl border border-slate-200/60 dark:border-zinc-800">
                  ...
                  <span>Klik <strong className="text-blue-500">"Add"</strong>. Buka aplikasi dari Home Screen!</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 pt-2">
              {deferredPrompt ? (
                <motion.button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 px-6 rounded-2xl shadow-lg shadow-blue-500/25 transition-all text-sm flex items-center justify-center gap-2 cursor-pointer"
                >
                ...
                <div className="bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-2xl p-4 text-left space-y-2.5">
                  <p className="text-xs font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider text-center">
                    Cara Install di Android / Tablet:
                  </p>
                  <div className="space-y-2 text-xs text-slate-700 dark:text-zinc-300">
                    <div className="flex items-center gap-2 bg-white dark:bg-zinc-900 p-2.5 rounded-xl border border-slate-200/60 dark:border-zinc-800">
                      <span className="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-bold flex items-center justify-center text-[11px] shrink-0">1</span>
                      <span>Buka menu browser <strong>Titik Tiga (⋮)</strong> di kanan atas.</span>
                    </div>
                    <div className="flex items-center gap-2 bg-white dark:bg-zinc-900 p-2.5 rounded-xl border border-slate-200/60 dark:border-zinc-800">
                      <span className="w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-bold flex items-center justify-center text-[11px] shrink-0">2</span>
