...
export const OnboardingScreen: React.FC<OnboardingScreenProps> = ({
  ...
  useEffect(() => {
    ...
    if (promise !== undefined) {
      promise.catch((error) => console.log('Autoplay fallback:', error));
    }
        ...
        <div className="flex-1 flex flex-col justify-center my-auto overflow-hidden">
          <AnimatePresence custom={direction} mode="wait">
            {step === 1 && (
              ...
              >
                <div className="w-20 h-20 rounded-3xl bg-blue-500/10 dark:bg-blue-500/15 border border-blue-500/20 mx-auto flex items-center justify-center p-3 shadow-inner">
                  <img src="/logombud.png" alt="Logo" className="w-full h-full object-contain" />
                </div>
            ...
            {step === 5 && (
              ...
              >
                <div className="relative mx-auto w-24 h-24 flex items-center justify-center">
                  ...
                  <div className="relative w-20 h-20 rounded-full bg-gradient-to-tr from-blue-600 to-indigo-500 text-white flex items-center justify-center shadow-xl shadow-blue-500/30">
                    <Sparkles className="w-10 h-10 stroke-[2.2]" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-[11px] font-extrabold tracking-widest uppercase text-blue-600 dark:text-blue-400 pt-2">
          ...
          {step === 4 ? (
            <>
              ...
              <button
                type="button"
                onClick={nextStep}
                className="w-full py-2 text-xs font-semibold text-slate-400 hover:text-slate-700 dark:hover:text-zinc-300 transition-colors cursor-pointer"
              >
                Nanti Saja
              </button>
            </>
