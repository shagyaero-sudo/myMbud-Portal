...
export const initialAppState: AppState = {
  ...
  announcements: [
    {
      id: 'ann-1',
      title: '📌 Perubahan Jam Kuliah Perencanaan Wilayah minggu ini',
    ...
    {
      id: 'ann-2',
      title: '📄 Pengumpulan Proposal Penelitian Metodologi Penelitian',
    ...
    {
      id: 'ann-3',
      title: '🎉 Agenda Makrab & Study Tour Kelas A Semester Ini',
  ...
  tasks: [
    {
      ...
      deadline: new Date(Date.now() + 1.5 * 24 * 3600 * 1000).toISOString(),
      status: 'in_progress',
      priority: 'High',
      attachment: {
    ...
    },
    {
      ...
      deadline: new Date(Date.now() + 3.5 * 24 * 3600 * 1000).toISOString(),
      status: 'todo',
      priority: 'High',
    },
    {
    ...
    },
    {
      ...
      type: 'Kelompok',
      assigner: 'Dr. Rina Wulandari, M.Si.',
      deadline: new Date(Date.now() - 4.5 * 24 * 3600 * 1000).toISOString(),
      status: 'done',
      priority: 'High',
      attachment: {
